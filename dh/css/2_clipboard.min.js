        ...
        7 : [function(t, e, n) {
            ...
            o.prototype = {
                ...
                off: function(t, e) {
                    ...
                    r = [];
                    if (o && e) for (var i = 0,
                    c = o.length; c > i; i++) o[i].fn !== e && o[i].fn._ !== e && r.push(o[i]);
        ...
        9 : [function(e, n, o) { !
            function(r, i) {
                if ("function" == typeof t && t.amd) t(["module", "./clipboard-action", "tiny-emitter", "good-listener"], i);
                    ...
                    i(c, r.clipboardAction, r.tinyEmitter, r.goodListener),
                    r.clipboard = c.exports
                }
            } (this,
            function(t, e, n, o) {
                "use strict";
